"use strict";
(self["webpackChunkrspack_repro"] = self["webpackChunkrspack_repro"] || []).push([[315],{
...
/* harmony export */ });
if (914 == __webpack_require__.j) {
	/* harmony import */ var _utils_bindActionCreators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(419);
}
if (914 == __webpack_require__.j) {
	/* harmony import */ var _wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(177);
}
if (914 == __webpack_require__.j) {
	/* harmony import */ var _invalidArgFactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(853);
}



function mapDispatchToPropsFactory(mapDispatchToProps) {
    return mapDispatchToProps && typeof mapDispatchToProps === 'object' ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsConstant */ .o6)((dispatch)=>(0,_utils_bindActionCreators__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(mapDispatchToProps, dispatch)) : !mapDispatchToProps ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsConstant */ .o6)((dispatch)=>({
            dispatch
        })) : typeof mapDispatchToProps === 'function' ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsFunc */ .Qb)(mapDispatchToProps, 'mapDispatchToProps') : (0,_invalidArgFactory__WEBPACK_IMPORTED_MODULE_2__/* .createInvalidArgFactory */ .i)(mapDispatchToProps, 'mapDispatchToProps');
}
...
if (914 == __webpack_require__.j) {
	/* harmony import */ var _invalidArgFactory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(853);
}


function mapStateToPropsFactory(mapStateToProps) {
    return !mapStateToProps ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsConstant */ .o6)(()=>({})) : typeof mapStateToProps === 'function' ? (0,_wrapMapToProps__WEBPACK_IMPORTED_MODULE_0__/* .wrapMapToPropsFunc */ .Qb)(mapStateToProps, 'mapStateToProps') : (0,_invalidArgFactory__WEBPACK_IMPORTED_MODULE_1__/* .createInvalidArgFactory */ .i)(mapStateToProps, 'mapStateToProps');
}
...
if (914 == __webpack_require__.j) {
	/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(950);
}
if (914 == __webpack_require__.j) {
	/* harmony import */ var _invalidArgFactory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(853);
}
...
if (914 == __webpack_require__.j) {
	/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105);
}

const _excluded = (/* runtime-dependent pure expression or super */ 914 == __webpack_require__.j ? ([
    "initMapStateToProps",
...
function finalPropsSelectorFactory(dispatch, _ref) {
    let { initMapStateToProps, initMapDispatchToProps, initMergeProps } = _ref, options = (0,_babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_ref, _excluded);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Ng: () => (/* reexport */ components_connect)
});

// UNUSED EXPORTS: ReactReduxContext, batch, createDispatchHook, createSelectorHook, createStoreHook, shallowEqual, useDispatch, useSelector, useStore
...
var with_selector = __webpack_require__(884);
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/react-redux@8.1.3_react-dom@17.0.2_react@17.0.2__react@17.0.2_redux@5.0.1/node_modules/react-redux/es/utils/batch.js
...
if (914 == __webpack_require__.j) {
var esm_extends = __webpack_require__(950);
}
...
if (914 == __webpack_require__.j) {
var objectWithoutPropertiesLoose = __webpack_require__(105);
}
...
if (914 == __webpack_require__.j) {
var selectorFactory = __webpack_require__(613);
}
...
if (914 == __webpack_require__.j) {
var connect_mapDispatchToProps = __webpack_require__(743);
}
...
if (914 == __webpack_require__.j) {
var connect_mapStateToProps = __webpack_require__(800);
}
...
if (914 == __webpack_require__.j) {
var connect_mergeProps = __webpack_require__(288);
}
;// CONCATENATED MODULE: ./node_modules/.pnpm/react-redux@8.1.3_react-dom@17.0.2_react@17.0.2__react@17.0.2_redux@5.0.1/node_modules/react-redux/es/utils/Subscription.js
...
// EXTERNAL MODULE: ./node_modules/.pnpm/react-redux@8.1.3_react-dom@17.0.2_react@17.0.2__react@17.0.2_redux@5.0.1/node_modules/react-redux/es/utils/useSyncExternalStore.js
if (914 == __webpack_require__.j) {
var useSyncExternalStore = __webpack_require__(739);
}
...
let connect_useSyncExternalStore = (/* runtime-dependent pure expression or super */ 914 == __webpack_require__.j ? (useSyncExternalStore/* notInitialized */.w) : null);
...
const NO_SUBSCRIPTION_ARRAY = (/* runtime-dependent pure expression or super */ 914 == __webpack_require__.j ? ([
    null,
    null
...
// @ts-ignore
pure, areStatesEqual = strictEqual, areOwnPropsEqual = shallowEqual/* default */.A, areStatePropsEqual = shallowEqual/* default */.A, areMergedPropsEqual = shallowEqual/* default */.A, // use React's forwardRef to expose a ref of the wrapped component
forwardRef = false, // the context consumer to use
context = Context_ReactReduxContext } = {}) {
    if (false) {}
    const Context = context;
    const initMapStateToProps = (0,connect_mapStateToProps/* mapStateToPropsFactory */.J)(mapStateToProps);
    const initMapDispatchToProps = (0,connect_mapDispatchToProps/* mapDispatchToPropsFactory */.q)(mapDispatchToProps);
    const initMergeProps = (0,connect_mergeProps/* mergePropsFactory */.ne)(mergeProps);
    ...
    const wrapWithConnect = (WrappedComponent)=>{
        ...
        function ConnectFunction(props) {
            const [propsContext, reactReduxForwardedRef, wrapperProps] = react.useMemo(()=>{
                ...
                const { reactReduxForwardedRef } = props, wrapperProps = (0,objectWithoutPropertiesLoose/* default */.A)(props, _excluded);
                return [
                    props.context,
                    reactReduxForwardedRef,
                    wrapperProps
            ...
            const childPropsSelector = react.useMemo(()=>{
                ...
                return (0,selectorFactory/* default */.A)(store.dispatch, selectorFactoryOptions);
            }, [
                store
            ]);
            ...
            try {
                actualChildProps = connect_useSyncExternalStore(subscribeForReact, // TODO and we're just passing that through so it triggers a re-render for us rather than relying on `uSES`.
...
/* harmony default export */ const components_connect = ((/* runtime-dependent pure expression or super */ 914 == __webpack_require__.j ? (connect) : null));
...
var redux_thunk = __webpack_require__(150);
...
var buildGetDefaultMiddleware = () => function getDefaultMiddleware(options) {
  ...
  if (thunk) {
    if (isBoolean(thunk)) {
      middlewareArray.push(redux_thunk/* thunk */.P);
    } else {
      middlewareArray.push((0,redux_thunk/* withExtraArgument */.Y)(thunk.extraArgument));
    }
  }
  if (false) {}
